 ...
 */
public class SaleInvoiceCtrl extends SecondaryWindow<PurchaseInvoiceView> implements Initializable {
    ...
    @FXML
    private MenuButton supplierSelect;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        nameColumn.setCellValueFactory(new PropertyValueFactory<PurchaseDetail,String>("clientName"));
        ...
        for (Supplier s: admin2.getAllData()) {
            ...
            menu.setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent event) {
                    ...
                    supplierSelect.setText("Cliente: "+s.getName());
                }
            });

...
public class StringValuesCustomerViewer {
    ...
    public static String editCustomer="Editar datos de Cliente";

    public static String searchCustomer="buscar Clientes";
    public static String searchValues="nombre, telefono, direccion";
